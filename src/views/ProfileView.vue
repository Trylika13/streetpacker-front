  ...
  <div class="min-h-screen bg-[#F4F7F5] text-[#1E2E2A] pb-24 lg:pb-0 font-sans lg:flex lg:items-stretch selection:bg-[#00A896]/10">
    ...
    <div class="p-6 pb-6 pt-[calc(24px+env(safe-area-inset-top))] bg-white border-b lg:border-b-0 lg:border-r border-[#E4ECE9] relative lg:w-80 lg:shrink-0 lg:flex lg:flex-col lg:h-screen lg:sticky lg:top-0 lg:pt-16">
      <div class="flex flex-col items-center mt-4 lg:mt-0 w-full">
        ...
        <span class="text-[9px] text-[#00A896] font-bold uppercase tracking-widest mt-0.5 flex items-center gap-1">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-1 gap-3">
            <button @click="router.push('/profile/spots')" class="bg-white p-4 lg:p-6 rounded-2xl border border-[#E4ECE9] hover:border-[#00A896]/30 hover:-translate-y-0.5 hover:shadow-sm transition-all text-left active:scale-95 group relative overflow-hidden flex flex-col justify-between lg:h-32">
              <span class="block">
                ...
                <span class="block text-[11px] font-medium text-[#5C756E]/80 mt-0.5">Mes spots partagés</span>
              </span>
              <span class="hidden lg:block text-xs text-[#5C756E]/50 mt-2">Gère tes emplacements sur la carte</span>

              <span class="absolute top-4 right-4 text-[#5C756E]/30 group-hover:text-[#00A896] transition-colors">
            ...
            <button @click="router.push('/profile/ads')" class="bg-white p-4 lg:p-6 rounded-2xl border border-[#E4ECE9] hover:border-[#00A896]/30 hover:-translate-y-0.5 hover:shadow-sm transition-all text-left active:scale-95 group relative overflow-hidden flex flex-col justify-between lg:h-32">
              <span class="block">
                ...
                <span class="block text-[11px] font-medium text-[#5C756E]/80 mt-0.5">Mes annonces</span>
              </span>
              <span class="hidden lg:block text-xs text-[#5C756E]/50 mt-2">Suis ou retire tes objets en vente sur le marketplace</span>
            ...
            <div class="bg-white rounded-2xl border border-[#E4ECE9] overflow-hidden shadow-[0_4px_20px_rgba(9,17,14,0.01)]">
              ...
              <button @click="router.push('/profile/favorites?tab=spots')" class="w-full px-5 h-14 flex items-center justify-between border-b border-[#E4ECE9] hover:bg-[#F4F7F5]/50 active:bg-[#F4F7F5] transition-colors text-left text-sm group">
                <span class="flex items-center gap-3 text-[#1E2E2A]">
                  ...
                  <span class="font-medium">Spots mis de côté</span>
                </span>
                <span class="flex items-center gap-2 text-[#5C756E]/40 group-hover:text-[#00A896] transition-colors">
              ...
              <button @click="router.push('/profile/favorites?tab=ads')" class="w-full px-5 h-14 flex items-center justify-between hover:bg-[#F4F7F5]/50 active:bg-[#F4F7F5] transition-colors text-left text-sm group">
                <span class="flex items-center gap-3 text-[#1E2E2A]">
                  ...
                  <span class="font-medium">Annonces suivies</span>
                </span>
                <span class="flex items-center gap-2 text-[#5C756E]/40 group-hover:text-[#00A896] transition-colors">
...
const fetchProfileStats = async () => {
  ...
  try {
    const adsRes = await api.get('/Ads/my-ads')
